// Utility functions for complete system export with all source files

import type { AdminState, PriceConfig, DeliveryZone, Novel } from '../context/AdminContext';

// Generate complete AdminContext.tsx file with current state
...
// Generate complete CartContext.tsx file
export function generateCartContextFile(): string {
  return `import React, { createContext, useContext, useReducer, useEffect } from 'react';
...
// Generate complete CheckoutModal.tsx file
export function generateCheckoutModalFile(): string {
...
// Generate complete PriceCard.tsx file
export function generatePriceCardFile(): string {
...
// Generate complete NovelasModal.tsx file
export function generateNovelasModalFile(): string {
...
export function generateSourceFiles(state: AdminState): { [key: string]: string } {
  return {
    ...
    'src/context/CartContext.tsx': generateCartContextFile(),
    'src/components/CheckoutModal.tsx': generateCheckoutModalFile(),
    'src/components/PriceCard.tsx': generatePriceCardFile(),
    'src/components/NovelasModal.tsx': generateNovelasModalFile(),
    'src/main.tsx': generateMainFile(),
    'src/index.css': generateIndexCssFile(),
    'src/App.tsx': generateAppFile(),
    'src/vite-env.d.ts': '/// <reference types="vite/client" />',
  };
}

// Helper functions to generate individual files
...
function generateIndexCssFile(): string {
